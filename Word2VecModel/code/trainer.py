...
print('number of words, tags =', len(words), len(labels))
...
for word in words:
    ...
    trainMatrix.append(vector)

trainMatrix = np.asmatrix(trainMatrix)

print('found', i, 'words in word2vec model out of', len(words))
print('train matrix shape = ', trainMatrix.shape)
